...
const IconHome     = (p) => <Icon {...p} d={["M4 11l8-7 8 7","M6 9.5V20h12V9.5"]} />;
...
const IconCompass  = (p) => <Icon {...p} d={["M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Z","M15.5 8.5l-2 5-5 2 2-5 5-2Z"]} />;
...
Object.assign(window, {
  ...
  IconUpload, IconTable, IconPhone, IconCalendar, IconUser, IconHome, IconSearch, IconChevron,
  IconClipboard, IconTrash, IconBriefcase, IconRefresh, IconEdit, IconPlus, IconCircleCheck,
  IconArrowRight, IconKey, IconLogOut, IconBookmark, IconFolder, IconShuffle, IconCompass,
});
