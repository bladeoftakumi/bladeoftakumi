...
{ icon: <IconPen />, name: "Essays", desc: "Written reflections — slower thoughts, set down with care.", href: "Essays.html", kind: "page", cue: "Read" }];
        ...
        <div className="wrap">
          ...
          <div className="tools-grid">
            <a className="tool-card" href="https://ruminationsondeath.com/" target="_blank" rel="noopener noreferrer">
              ...
              <p className="tool-desc">A quiet meditation on mortality. Reflect on death to increase urgency.</p>
              <span className="tool-open">Open tool <IconArrowUR /></span>
            </a>
            <a className="tool-card" href="https://rihla.bladeoftakumi.com/" target="_blank" rel="noopener noreferrer">
              <span className="tool-tag mono">Route Planner · v1.0</span>
              <h3 className="tool-name">Rihla</h3>
              <p className="tool-desc">My workflow for IRL outreach.</p>
              <span className="tool-open">Open tool <IconArrowUR /></span>
            </a>
            <a className="tool-card" href="Suzuri.html">
              <span className="tool-tag mono">Essay Composer · v1.0</span>
              <h3 className="tool-name">Suzuri</h3>
              <p className="tool-desc">A tool that auto-formats my essays, ready to upload.</p>
              <span className="tool-open">Open tool <IconArrowUR /></span>
            </a>
          </div>
        </div>
